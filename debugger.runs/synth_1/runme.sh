...
HD_PWD='C:/Users/DrSnadi/debugger/debugger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_debugger.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_debugger.tcl
