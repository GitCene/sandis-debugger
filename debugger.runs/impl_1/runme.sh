...
HD_PWD='C:/Users/DrSnadi/debugger/debugger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_debugger.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_debugger.tcl -notrace
